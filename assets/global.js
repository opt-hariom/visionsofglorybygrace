...
class VariantSelects extends HTMLElement {
	...
	updateMedia(html) {
		const updateMedia = this.dataset.updateMedia == 'true'
	...
	renderProductInfo() {
		...
		fetch(
			...
			.then((responseText) => {
				...
				const saleTagDestination = document.getElementById(`ProductSaleTag-${this.dataset.section}`)
				const saleTagSource = html.getElementById(
					`ProductSaleTag-${this.dataset.originalSection ? this.dataset.originalSection : this.dataset.section}`
				)
				...
				if (saleTagDestination && saleTagSource) saleTagDestination.innerHTML = saleTagSource.innerHTML
